    ...
    <div className="how-works">
      <div className="container">
        <div className="head-how">
          <h2>
            How it <mark className="banner-con work-mark">works</mark>
          </h2>
          <p>
            Our steps are simple and easy to understand: Request - Receive -
            Track - Settle in
          </p>
        </div>
        <div className="wrapper mob-none">
          <div className="tabs-wrapper">
            ...
            <ul id="scroller" className="nav nav-tabs tab-slider">
              <li>
                <div
                  className={`a-tab-sl Raise-a pulse-tab ${
                    step >= 1 ? " pulse-tab" : ""
                  }`}
                  data-toggle="tab"
                  onClick={() => {
              ...
              <li>
                ...
                <span className="tab-slider-de">Receive Designs</span>
              ...
              <li>
                ...
                <span className="tab-slider-de">Track & Transact</span>
              ...
              <li>
                ...
                <span className="tab-slider-de">Settle In</span>
              </li>
            </ul>
          ...
          <div className="tab-content img-cont-tabslider">
            <div id="menu1" className="tab-pane active">
              <img
                className="d-block himanshu-code"
                src={require("../images/raise-request.png")}
                alt="First slide"
              />
              <p>
                Submit your requirements for your Dream House. Share the
                dimensions and desired rquirement in detail.{" "}
              </p>
            </div>
            ...
            <div id="menu4" className="tab-pane fade">
              <img
                className="d-block himanshu-code"
                src={require("../images/receive-design.jpg")}
                alt="First slide"
                style={{ width: "30%" }}
              />
              <p>
                Our AI Engine will blend it and generate Beautiful Layouts for
                your selection.{" "}
              </p>
            </div>
            <div id="menu5" className="tab-pane fade">
              <img
                className="d-block himanshu-code"
                src={require("../images/track.gif")}
                alt="First slide"
              />
              <p>
                Make your choice and share with us for further blending. Nuvanco
                will share detailed MEP Layouts.
              </p>
            </div>
            <div id="menu6" className="tab-pane fade">
              <img
                className="d-block himanshu-code"
                src={require("../images/settle.jpg")}
                alt="First slide"
              />
              <p>
                {" "}
                Now it’s time to construct your Dream House. Feel free to
                connect with us for any customized requirements!
              </p>
            </div>
          </div>
        </div>
